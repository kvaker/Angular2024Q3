...
export class SearchDataService {
  ...
  getMockSearchResults(): Observable<SearchResponse> {
      ...
      items: [
        ...
        },
        {
          ...
          snippet: {
            ...
            description: "В этом видео речь пойдет про javascript фреймворк Angular. Я расскажу что такое Angular, где и когда его применяют, а так же сделаю небольшой обзор его возможностей.",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description: "Learn the basics of Angular 8 🚀 by building a tic-tac-toe game 🕹️ from scratch...",
            thumbnails: {
              default: {
